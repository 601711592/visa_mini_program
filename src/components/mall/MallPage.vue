<template>
  <view class="mx-page"><slot name="navigation" /><PreviewBadge />
...
import { useMallPreviewStore } from '@/store/mall-preview';import { go } from '@/mall/navigation';import { currentUrl } from '@/utils/auth-routing';
import PreviewBadge from './PreviewBadge.vue';import MallIcon from './MallIcon.vue';
...
<style lang="scss">@import '@/mall/theme.scss';</style>
