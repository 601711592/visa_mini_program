<template>
  <view class="optional-material-item" :class="{ selected: isSelected }" @click="handleSelect">
    <view class="optional-item-content">
      ...
      <view class="optional-media-buttons">
        <MediaPreview v-if="option.imageUrl" :image-url="option.imageUrl" @click.stop />
        <MediaPreview v-if="option.videoUrl" :image-url="option.imageUrl" :video-url="option.videoUrl" @click.stop />
      </view>
    </view>
  </view>
</template>
