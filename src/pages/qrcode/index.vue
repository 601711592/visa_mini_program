<template>
  <layout :navbar="{ backgroundColor: '#fff', fixed: true }">
    <view class="page">
      ...
      <view class="search m-[0_24px] rd-2 h60 flex items-center mt-2" border="1px solid #DCDCDC">
        <input type="text" placeholder="请输入您要搜索的商品关键词" class="flex-1 text-center" />
      </view>
      <view class="w700 h400 m-[24px_auto_0] bg-blue"></view>
